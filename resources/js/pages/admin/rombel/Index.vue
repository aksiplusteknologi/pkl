    ...
    <div>
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Pelaksanaan Rombongan Belajar</h4>
                <p class="text-muted mb-0">Menampilkan {{ table.totalRows }} Data Pelaksanaan Rombongan Belajar</p>
            </div>
            <!--end card-header-->
            <div class="card-body">
                <div class="table-responsive">
                    ...
                    >
                        ...
                        >
                            ...
                            <span v-if="props.column.field == 'prodi'">{{ props.row.prodi.nama }}</span>
                            <span v-if="props.column.field == 'tahun_ajaran'">{{ props.row.tahun_ajaran }}</span>
...
export default {
    ...
    methods: {
        initData: function () {
            ...
            axios.get("/api/admin/rombel", { params }).then((res) => {
