                    ...
                    <div class="collapse navbar-collapse tab-content" id="sidebarCollapse">
                        ...
                        <ul class="navbar-nav tab-pane active" id="Main" role="tabpanel">
                            <li class="menu-label mt-0 text-primary font-12 fw-semibold">
                                ...
                                <span>ain</span>
                                <br />
                                <span class="font-10 text-secondary fw-normal">Unique Dashboard</span>
                            </li>
                            <li class="nav-item">
                                <a
                                    class="nav-link"
                            ...
                            <li class="menu-label mt-0 text-primary font-12 fw-semibold">
                                ...
                                <span>pps</span>
                                <br />
                                <span class="font-10 text-secondary fw-normal">Morder Applications</span>
                            </li>
                            ...
                            <li class="menu-label mt-0 text-primary font-12 fw-semibold">
                                ...
                                <span>omponents</span>
                                <br />
                                <span class="font-10 text-secondary fw-normal">Bootstrap & Custom</span>
                            </li>
                            <li class="nav-item">
                                <a
                                    class="nav-link"
                            ...
                            <li class="menu-label mt-0 text-primary font-12 fw-semibold">
                                ...
                                <span>rafted</span>
                                <br />
                                <span class="font-10 text-secondary fw-normal">Unique Extra Pages</span>
                            </li>
                            <li class="nav-item">
                                <a
                                    class="nav-link"
                        ...
                        <ul class="navbar-nav tab-pane" id="Extra" role="tabpanel">
                            <li>
                                <div class="update-msg text-center position-relative">
                                    ...
                                    <p
                                        class="mb-3"
                                    >We Design and Develop Clean and High Quality Web Applications</p>
                                    <a
                ...
                <ul class="list-unstyled topbar-nav float-end mb-0">
                    ...
                    <li class="dropdown notification-list">
                        ...
                        <div class="dropdown-menu dropdown-menu-end dropdown-lg pt-0">
                            ...
                            >
                                Emails
                                <span class="badge bg-soft-primary badge-pill">3</span>
                            </h6>
